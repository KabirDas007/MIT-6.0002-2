...
class WeightedEdge(Edge):
    ...
    def __str__(self):
        #result = super().__str__() + ' (' + str(WeightedEdge.get_total_distance(self)) +', ' + str(WeightedEdge.get_outdoor_distance(self)) + ')'
        res = str(self.src) + '->' + str(self.dest) +' (' + str(WeightedEdge.get_total_distance(self)) +', ' + str(WeightedEdge.get_outdoor_distance(self)) + ')'
        return res
        #pass  # TODO
